    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="sub-container settings">
                ...
                <form method="POST" action="php/form-handlers.php" class="theme-form" id="theme-form" name="theme-form">
                    <label for="theme">Select Theme</label>
                    <?php themeSelection($CONN, $USERNAME); ?>

                    <input type="submit" name="theme-button" id="theme-button" value="Update">
                </form>
