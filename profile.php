...
<div id="body">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="profile-info sub-container">

                <?php getProfileInfo($CONN, $USERNAME); ?>

                <input type="button" class="edit-profile-button" id="edit-profile-button" onclick="openForm()" value="Edit Profile">
...
<?php displayProfileForm($CONN, $USERNAME) ?>
